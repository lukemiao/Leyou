...
import com.elasticsearch.repository.ItemRepository;
...
public class ElasTests {
    ...
    public void testAgg() {
        ...
        // 不查询任何结果      前者包含 字段  后者 排除字段
        queryBuilder.withSourceFilter(new FetchSourceFilter(new String[]{""}, null));  //和下面相同
