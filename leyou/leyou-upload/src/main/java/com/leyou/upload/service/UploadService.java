...
public class UploadService {
    ...
    public String uploadImage(MultipartFile file) {
        ...
        String originalFilename = file.getOriginalFilename(); //获得文件原始名字
        //校验文件类型
//        if(StringUtils.substringAfterLast())
        // 获取文件类型
        ...
        try {
            ...
            //保存到服务器
            //这个是本地
//            file.transferTo(new File("E:\\javaitem\\application\\image\\" + originalFilename));
